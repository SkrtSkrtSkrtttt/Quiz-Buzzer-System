//Naafiul Hossain 
#define button1 9 //the number of the button 1
#define button2 4 //button2 attach to
#define button3 3 //button3 attach to 
#define button4 2 //button4 attach to
#define buzzerPin 5 //the buzzer attach to 
#define LED1 10 //LED1  attach to 
#define LED2 6 //LED2  attach to 
#define LED3 7 //LED3  attach to 
#define LED4 8 //LED4 attach to
...
void setup()
{
  //initialize buzzer,LED1, LED2, LED3
   pinMode(buzzerPin, OUTPUT); 
   pinMode(LED1, OUTPUT);
   pinMode(LED2, OUTPUT); 
   pinMode(LED3, OUTPUT); 
   pinMode(LED4, OUTPUT);
  //initialize button1,button2,button3  as input,combined with pullup
